...
private:
	...
	enum
	{
		...
		COND_CIT_FOUNDCUTTABLEDOOR, //we have found a door that can bge cut down
		...
		TASK_CIT_GET_PATH_TO_CUTTABLE_DOOR, // finds a path to and travels to a found cuttable door
		TASK_CIT_FACE_CUTTABLE_DOOR, // face a cuttable door we've found
		TASK_CIT_PLAY_DOOR_CUT_SOUND, // play the blowtorch sound when cutting doors
		TASK_CIT_DESTROY_CUTTABLE_DOOR, // remove the door being cut down
#ifdef HL2_EPISODIC
		TASK_CIT_HEAL_TOSS,
#endif
