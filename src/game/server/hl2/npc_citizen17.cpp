...
void CNPC_Citizen::StartTask(const Task_t *pTask)
{
	...
	case TASK_CIT_FACE_CUTTABLE_DOOR:
		if (GetCuttableDoorTarget())
		{
			...
			GetMotor()->SetIdealYawAndUpdate(targetAngles.y + 90);
			TaskComplete();
...
DECLARE_TASK(TASK_CIT_FACE_CUTTABLE_DOOR)
DECLARE_TASK(TASK_CIT_PLAY_DOOR_CUT_SOUND)
DECLARE_TASK(TASK_CIT_GET_PATH_TO_CUTTABLE_DOOR)
DECLARE_TASK(TASK_CIT_DESTROY_CUTTABLE_DOOR)
#if HL2_EPISODIC
...
DECLARE_CONDITION(COND_CIT_FOUNDCUTTABLEDOOR)
...
DEFINE_SCHEDULE
(
SCHED_CITIZEN_CUT_DOOR_DOWN,

"	Tasks"
// i don't have voicelines, so the sentence is just gonna be the NPC saying "okay"
//"		TASK_SPEAK_SENTENCE					  0" 
"		TASK_CIT_GET_PATH_TO_CUTTABLE_DOOR	  0"
//"		TASK_MOVE_TO_TARGET_RANGE			  20"
"		TASK_WAIT_FOR_MOVEMENT				  0"
"		TASK_CIT_FACE_CUTTABLE_DOOR			  0"
"		TASK_CIT_PLAY_DOOR_CUT_SOUND		  0"
"		TASK_WAIT							  10"
"		TASK_CIT_DESTROY_CUTTABLE_DOOR		  0"
""
"	Interrupts"
// TODO: add interrupts for damage and make it so door cut progress is saved between hits
)
